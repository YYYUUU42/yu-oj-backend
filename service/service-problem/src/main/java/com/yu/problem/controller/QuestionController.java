package com.yu.problem.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.gson.Gson;
import com.yu.common.annotation.AuthCheck;
import com.yu.common.common.BaseResponse;
import com.yu.common.common.DeleteRequest;
import com.yu.common.common.ErrorCode;
import com.yu.common.common.ResultUtils;
import com.yu.common.constant.UserConstant;
...
import com.yu.model.dto.question.*;
...
import com.yu.problem.job.RecommendedTiming;
import com.yu.problem.manage.RedissonLimiter;
...
public class QuestionController {
    ...
    @ApiOperation(value = "获得推荐题目")
    public BaseResponse<Page<QuestionVO>> getRecommendedList(@RequestBody QuestionQueryRequest questionQueryRequest,
                                                             HttpServletRequest request) {
        long current = questionQueryRequest.getCurrent();
        long size = questionQueryRequest.getPageSize();
        User loginUser = userFeignClient.getLoginUser(request);
        ...
        page.setSize(size);
        List<Question> questionList = questionService.getRecommendedList(questionQueryRequest,loginUser);
    ...
    @Resource
    private RecommendedTiming recommendedTiming;

    @PostMapping("test")
    public BaseResponse RecommendedList(){
        recommendedTiming.updateRecommendedList();
        recommendedTiming.updateRecommendedList();
